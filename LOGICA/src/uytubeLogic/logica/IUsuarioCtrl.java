...
public interface IUsuarioCtrl {
	...
	public abstract void aniadirVideo(String nickU, String nombreV, String descripcionV, Integer duracionV,
			DtFecha fechaPublicacionV, String urlV, DtCategoria catV, Privacidad privacidadV);

	public abstract void ingresarNuevosDatosVideo(String nickU, String nuevoNombreV, String nuevaDescripcionV,
			int nuevaDuracionV, DtFecha nuevaFechaPublicacionV, String nuevaURL, DtCategoria nuevaCatV,
			Privacidad nuevaPrivacidadV);

	public abstract Boolean verificarDispUsuario(String nickU, String email);

	public abstract void nuevoUsuario(String nickU, String pass, String nombreU, String apellidoU, String emailU,
	...
	public abstract void editarDatosUsuario(String nickU, String nuevoNombreU, String nuevoApeliidoU,
			DtFecha nuevaFechaNacU, byte[] nuevaFotoU);
	...
	public abstract void modificarDatosCanal(String nickname, String nombreCanal, String descripcion,
	...
	public abstract DtVideo[] infoVideosCanal(String filtro, String nickU, Privacidad priv);

	public abstract DtListaReproduccion[] infoLDRdeUsuario(String filtro, String nickU, Privacidad priv);
