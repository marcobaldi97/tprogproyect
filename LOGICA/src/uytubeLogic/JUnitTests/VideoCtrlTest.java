...
public class VideoCtrlTest {
	...
	public void testListarVideosPorCategoriaExiste() {
		...
		Video video2 = new Video("nombre2LPCE", "duenio2LPCE", "descr2", 20, fecha, "hola2.com", cate,
				Privacidad.PRIVADO);
	...
	public void testComentarios() {
		...
		UCU.nuevoUsuario(duenioVideo, "Jose", "1234", "Perez", "email", fecha, null, "duenioCanal", "descripcion",
				Privacidad.PRIVADO, "nombreCategoria");
		UCU.nuevoUsuario(comentadorVideo1, "1234", "Roberto", "Rodriguez", "email2", fecha, null, "duenioCanal2",
				"descripcion2", Privacidad.PRIVADO, "nombreCategoria");
		...
		assertEquals(true, ComentActuales[0].isEsPadre() == true);
		...
		assertEquals(true, ComentActuales[0].getRespuestas()[0].isEsPadre() == false);
	...
	public void testValorarVideo() {
		...
		UCU.nuevoUsuario(duenioVideo, "1234", "Jose", "Perez", "email", fecha, null, "duenioCanal", "descripcion",
				Privacidad.PRIVADO, "nombreCategoria");
		UCU.nuevoUsuario(gustaVideo1, "1234", "Juan", "Gimenez", "email3", fecha, null, "duenioCanal3", "descripcion3",
				Privacidad.PRIVADO, "nombreCategoria");
		UCU.nuevoUsuario(noGustaVideo1, "1234", "Pablo", "Pereira", "email4", fecha, null, "duenioCanal4",
				"descripcion4", Privacidad.PRIVADO, "nombreCategoria");
