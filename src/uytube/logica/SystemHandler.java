...
public class SystemHandler {
	...
	public void aniadirListaDefault(DtListaReproduccion nuevaListaPorDefecto) {
		listasDefault.put(nuevaListaPorDefecto.getNombre(),
				nuevaListaPorDefecto);
	}
	...
	public DtListaReproduccion[] obtenerListasReproduccion() {
		DtListaReproduccion[] dtListas = new DtListaReproduccion[listasDefault
				.size()];
		int contador = 0;
		for (Map.Entry<String, DtListaReproduccion> entry : listasDefault
				.entrySet()) {
