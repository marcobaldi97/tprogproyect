...
public interface IVideoCtrl {
	...
	public abstract void nuevoComentario(Integer IDVideo,String nickU,DtFecha fecha,String contenido);
	public abstract void responderComentario(Integer IDVideo, Integer IDCR, String nickU, DtFecha fecha, String contenido);
	public abstract void valorarVideo(Integer IDVideo, String nickU, boolean valoracion);
