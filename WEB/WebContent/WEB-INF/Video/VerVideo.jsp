...
<head>
	...
	window.onload=function(){
		...
		}//si no est� loggeado, no muestra estos elementos.
	}
	...
	function me_gusta_script() {
		...
		xhttp.send();
		console.log("ya env�e la request");
	}
	...
	function ir_a_perfil(nombre_due�o_perfil){
		request.setParameter("opcion") = "Perfil";
		request.setParameter("nombre_due�o_perfil") = nombre_due�o_perfil;
...
<body >
	...
	<%!//funciones Java
		...
		}//esta funci�n genera el c�digo html para el boton combo box para agregar un video a una lista de reproduccion.
