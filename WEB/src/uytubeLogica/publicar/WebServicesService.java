...
public class WebServicesService extends Service {
    ...
    public final static QName SERVICE = new QName("http://publicar.uytubeLogica/", "WebServicesService");
    public final static QName WebServicesPort = new QName("http://publicar.uytubeLogica/", "WebServicesPort");
    static {
        URL url = null;
        try {
